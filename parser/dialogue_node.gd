...
## A class used to represent a DialogueNode in Snake River Dialogue Editor. Has a dictionary, fields,
## and outputs, as well as some other data.

## The dictionary the DialogueNode represents (outputs, fields, etc.)
